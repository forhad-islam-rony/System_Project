    ...
    <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-gray-800 container mt-[-80px]'>
        ...
        <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-scroll'>
          {specialityData.map((item, index) => (
            <Link className='flex flex-col items-center text-xs cursor-pointer flex-shirnk-0 hover:translate-y-[-10px] translate-all duration-500' key={index} to={`/doctors/${item.speciality}`}>
